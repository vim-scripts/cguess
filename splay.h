...
typedef PTR (*splay_tree_allocate_fn) PARAMS((int));

/* The type of a function used to free memory allocated using the
   corresponding splay_tree_allocate_fn.  The first argument is the
   memory to be freed; the latter is a data pointer the splay tree
   functions pass through to the freer.  */
typedef void (*splay_tree_deallocate_fn) PARAMS((void *));
...
extern splay_tree_node splay_tree_min
                                        PARAMS((splay_tree));
extern void splay_tree_foreach           PARAMS((splay_tree,
...
#define splay_s splay_tree_s

/*
 * The function type for iterating over nodes.
 */
typedef int (*splay_iterator_t) (void *, void *);
